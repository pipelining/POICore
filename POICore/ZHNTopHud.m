...
+ (ZHNTopHud *)shareinstance {
    ...
    dispatch_once(&onceToken, ^{
        ...
        containerView.frame = CGRectMake(KHudPadding, KHudPadding, Width - 2 * KHudPadding, KHudHeight);
        ...
        indicatorView.center = CGPointMake(20, yDelta + KStatusBarFitHeight + 10);
        ...
        titleLabel.frame = CGRectMake(40, KStatusBarFitHeight, Width - 50, KHudContentHeight);
        // shadow
...
+ (void)showLoadingWithMessage:(NSString *)message {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        _showing = YES;
        [ZHNTopHud shareinstance].iconImageView.image = nil;
        [ZHNTopHud shareinstance].titleLabel.text = message;
        [ZHNTopHud shareinstance].hudWindow.hidden = NO;
        [[ZHNTopHud shareinstance].indicatorView startAnimating];
...
+ (void)showMessage:(NSString *)message withIconImagename:(NSString *)imagename {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        _showing = YES;
        [[ZHNTopHud shareinstance].indicatorView stopAnimating];
...
+ (void)showLoading:(NSString *)loading {
    [ZHNTopHud showLoadingWithMessage:loading];
}
